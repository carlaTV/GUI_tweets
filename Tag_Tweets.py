...
with open('retrieved_tweets_spain.json','r') as f:
    ...
    for i in range(0,3):
        ...
        layout = [
                  ...
                  [sg.Text("Tweet:\n"+text,font=("Calibri",16))],
                  [sg.Text(translator.translate(text, dest='ru').text,font=("Calibri",16))],
                  [sg.Text(translator.translate(text, dest='en').text,font=("Calibri",16))],
                  [sg.Text('Geolocation', size=(15, 1)), sg.InputCombo(['0', '1'])],
                  [sg.Text('Relevance', size=(15, 1)), sg.InputCombo(['0', '1'])],
                  [sg.Text('Time', size=(15, 1)), sg.InputCombo(['none','f', 'p'])],
                  [sg.Text('Spain', size=(15, 1)), sg.InputCombo(['yes', 'no', 'undefined'])],
                  [sg.Text('Narrow Geolocation', size=(15, 1)), sg.InputCombo(['yes', 'no'])],
